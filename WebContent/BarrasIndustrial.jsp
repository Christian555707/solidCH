...
<option value ="BarDemEne [GWh]" selected> Energía [GWh] </option>
<option value ="BarDemPot [MW]"> Potencia [MW] </option>
 </select>
<!-- </select><br>  -->
</tr><tr>
...
<tr>
Barra: <input type="text" id="selectBar2P" list="itemsP" name="selectBar2P" value="Carrera Pinto 220">
<datalist id="itemsP">
...
function loadDocTotal() {
 ...
 //   	document.getElementById('aqui').innerHTML ="len List:"+Object.keys( obj.List ).length +" len a:"+Object.keys( obj.A ).length+" len B:"+Object.keys( obj.B ).length;// Borrar
  ...
  xhttp.open('POST', 'http://localhost:8080/Intento2/BarDemIndTotal.jsp', true);//"http://localhost:8080/Intento2/WebContent/Datos2.jsp"
  //xhttp.setRequestHeader("Content-type","application/json; charset=utf-8");
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
<tr>
Barra: <input type="text" id="selectBar2T" list="itemsP" name="selectBar2T" value="Carrera Pinto 220">
<datalist id="itemsT">
<option value ="Agua Santa 110"> Agua Santa 110 </option>
<option value ="Algarrobo 110"> Algarrobo 110 </option>
<option value ="Alto Jahuel 110"> Alto Jahuel 110 </option>
...
function loadDoc() {
  ...
  xhttp.open('POST', 'http://localhost:8080/Intento2/BloquesDatos.jsp', true);//"http://localhost:8080/Intento2/WebContent/Datos2.jsp"
  //xhttp.setRequestHeader("Content-type","application/json; charset=utf-8");
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
