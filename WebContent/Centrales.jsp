...
<h1>Potencia Promedio por central</h1>
...
<option value ="CenPotOpeMed MW" selected> Media [MW] </option>
<option value ="CenPotOpeMax MW"> Máxima [MW] </option>
<option value ="CenPotOpeMin MW"> Mínima [MW] </option>
 </select>
<!-- </select><br>  -->
</tr><tr>
Central/Unidad:</tr><tr> <input type="text" id="selectBarP" list="itemsP" name="selectBarP" value="">
<datalist id="itemsP">
...
<tr>
Central/Unidad: <input type="text" id="selectBar2P" list="itemsP" name="selectBar2P" value="">
<datalist id="itemsP">
<option value ="Guacolda 01"> Guacolda 01 </option>
<option value ="Campiche"> Campiche </option>
<option value ="Las Pampas"> Las Pampas </option>
...
<h1>Energía total por central</h1>
...
<!--Variable: <select name = "selectVar"> -->
<option value ="CenPotOpeMed MW" selected> Media [MWh] </option>
<option value ="CenPotOpeMax MW"> Máxima [MWh] </option>
<option value ="CenPotOpeMin MW"> Mínima [MWh] </option>
 </select>
<!-- </select><br>  -->
</tr><tr>
Central/Unidad:</tr><tr> <input type="text" id="selectBarT" list="itemsT" name="selectBarT" value="">
<datalist id="itemsT">
...
<tr>
Central/Unidad: <input type="text" id="selectBar2T" list="itemsT" name="selectBar2T" value="">
<datalist id="itemsT">
<option value ="Guacolda 01"> Guacolda 01 </option>
<option value ="Campiche"> Campiche </option>
<option value ="Las Pampas"> Las Pampas </option>
...
Central/Unidad:</tr><tr> <input type="text" id="selectBar" list="items" name="selectBar" value="">
<datalist id="items">
...
<tr>
Central/Unidad: <input type="text" id="selectBar2" list="items" name="selectBar2" value="">
<datalist id="items">
