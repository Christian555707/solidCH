...
<ul>
  ...
  <li><a href="#news">Centrales</a></li>
  <li><a href="IndexBarras.html">Barras</a></li>
  <li><a href="#about">Lineas</a></li>
</ul>
...
<tr>
Barra: <input type="text" id="selectBar2P" list="itemsP" name="selectBar2P" value="Algorta 033">
<datalist id="itemsP">
<option value =""> Text </option>
...
<tr>
Barra: <input type="text" id="selectBar2T" list="itemsP" name="selectBar2T" value="Algorta 033">
<datalist id="itemsT">
<option value =""> Text </option>
<option value ="Agua Santa 110"> Agua Santa 110 </option>
<option value ="Algarrobo 110"> Algarrobo 110 </option>
