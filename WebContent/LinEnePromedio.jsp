...
if( año.equals("2023") ){break;}
        ...
        if (barnom.equals(request.getParameter("selectBarT")) ){
        	...
        	if(!(mes+año).equals(Label.get(i))){
        		...
        		Label.add(mes+año);
        		A.add(Double.valueOf(variable)*Double.valueOf(EtaHrs));
        		B.add(Double.valueOf(0));
        		i++;    		
        	} else {
        		//System.out.println(" A:"+A.get(i) + " "+i);
        		A.set(i, A.get(i) + Double.valueOf(variable)*Double.valueOf(EtaHrs));
        	
        };
    };
 /*        if (barnom.equals(request.getParameter("selectBar2T"))	){
        	//B.add(Double.valueOf(etanom));
        	B.set(i, B.get(i) + Double.valueOf(variable)*Double.valueOf(EtaHrs));
        }
  */      
    }
