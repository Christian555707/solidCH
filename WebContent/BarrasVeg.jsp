...
function loadDocPromedio() {
 ...
 //   	document.getElementById('aqui').innerHTML ="len List:"+Object.keys( obj.List ).length +" len a:"+Object.keys( obj.A ).length+" len B:"+Object.keys( obj.B ).length;// Borrar
  ...
  xhttp.open('POST', 'http://localhost:8080/Intento2/Datos2Veg.jsp', true);//"http://localhost:8080/Intento2/WebContent/Datos2.jsp"
...
<h1>Demanda Promedio por barras</h1>
...
Barra:</tr><tr> <input type="text" id="selectBarP" list="itemsP" name="selectBarP" value="Agua Santa 110">
<datalist id="itemsP">

<option value ="Agua Santa 110" selected> Agua Santa 110 </option>
<option value ="Algarrobo 110"> Algarrobo 110 </option>
<option value ="El Lince 023"> El Lince 023 </option>
...
<tr>
Barra: <input type="text" id="selectBar2P" list="itemsP" name="selectBar2P" value="El Lince 023">
<datalist id="itemsP">
<option value =""> Text </option>
...
function loadDocTotal() {
 ...
 //   	document.getElementById('aqui').innerHTML ="len List:"+Object.keys( obj.List ).length +" len a:"+Object.keys( obj.A ).length+" len B:"+Object.keys( obj.B ).length;// Borrar
  ...
  xhttp.open('POST', 'http://localhost:8080/Intento2/BarDemIndTotalVeg.jsp', true);//"http://localhost:8080/Intento2/WebContent/Datos2.jsp"
  //xhttp.setRequestHeader("Content-type","application/json; charset=utf-8");
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
<h1>Demanda Total por barras</h1>
...
Barra:</tr><tr> <input type="text" id="selectBarT" list="itemsT" name="selectBarT" value="Agua Santa 110">
<datalist id="itemsT">
...
<tr>
Barra: <input type="text" id="selectBar2T" list="itemsP" name="selectBar2T" value="El Lince 023">
<datalist id="itemsT">
<option value =""> Text </option>
<option value ="Agua Santa 110"> Agua Santa 110 </option>
<option value ="Algarrobo 110"> Algarrobo 110 </option>
...
function loadDoc() {
  ...
  xhttp.open('POST', 'http://localhost:8080/Intento2/BloquesDatosVeg.jsp', true);//"http://localhost:8080/Intento2/WebContent/Datos2.jsp"
  //xhttp.setRequestHeader("Content-type","application/json; charset=utf-8");
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
