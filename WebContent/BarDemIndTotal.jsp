...
<%@page import="org.json.JSONObject"%>
    ...
    for (CSVRecord record : records) {
        ...
        if (barnom.equals(request.getParameter("selectBarT")) ){//if (barnom.equals(request.getParameter("selectBarT")) && bardemfmt.equals("BarDemInd")){
         ...
         if (barnom.equals(request.getParameter("selectBar2T")) 	){//if (barnom.equals(request.getParameter("selectBar2T")) && bardemfmt.equals("BarDemInd")	){
